...
<body bgcolor="black">
    ...
    <center>
        <font color="F5C518" face="times new roman" size="12">List Of Banned General Users</font><br><br><br>
        ...
        <?php 
            ...
            <tr>
                ...
                while($w=mysqli_fetch_assoc($result)){
                    ...
                    <td><a href=\"../Controllers/recover-controller.php?id={$userid}\"><font color=\"5799EF\" face=\"times new roman\" size=\"5\">Recover General User</font></a></td>          
                    </tr>";
                }
            }else{
                echo"<tr><td align=\"center\"><font color=\"white\" face=\"times new roman\" size=\"6\">No Banned General Users Found</font></td></tr>";
            }
        ?>
        </table>
