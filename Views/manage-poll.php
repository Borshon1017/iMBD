...
<body bgcolor="black">
    ...
    <center>
        ...
        <table width="60%" bgcolor="black" border="0" cellspacing="0" cellpadding="10">
            <tr align="center">
                <td>
                    <a href="upload-content.php"><font color="white" face="times new roman" size="6">Create Poll</font></a>
                </td>
            </tr>
            <tr align="center">
                <td>
                    <a href="edit-content-info.php"><font color="white" face="times new roman" size="6">Edit Poll</font></a>
                </td>
            </tr>
        </table>
