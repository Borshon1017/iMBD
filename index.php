        ...
        <tr>
            <td valign="top">
                ...
                <a href="Views/movies.php">
                    <font color="F5C518" face="times new roman" size="12">Movies</font>
                </a><br>
                <hr color="F5C518" width="530px" align="left"><br>
                <a href="Views/movies.php">
                    <font color="5799EF" face="times new roman" size="4">More to explore</font>
                </a><br><br>
                ...
                <a href="Views/tv-shows.php">
                    <font color="F5C518" face="times new roman" size="12">TV Shows</font>
                </a><br>
                <hr color="F5C518" width="530px" align="left"><br>
                <a href="Views/tv-shows.php">
                    <font color="5799EF" face="times new roman" size="4">More to explore</font>
                ...
                <a href="Views/animes.php">
                    <font color="F5C518" face="times new roman" size="12">Animes</font>
                </a><br>
                <hr color="F5C518" width="530px" align="left"><br>
                <a href="Views/animes.php">
                    <font color="5799EF" face="times new roman" size="4">More to explore</font>
            ...
            <td valign="top">
                ...
                <a href="Views/new-arrivals.php">
                    <font color="F5C518" face="times new roman" size="12">New Arrivals</font>
                </a>
                <hr color="F5C518" width="530px" align="left"><br>
                <a href="Views/new-arrivals.php">
                    <font color="5799EF" face="times new roman" size="4">See More</font>
                </a><br><br><br>
                <table width="90%" bgcolor="black" border="0" cellspacing="0" cellpadding="15">
                    <?php $counter = 0;
                ...
                <a href="#" onclick="redirectToRandomPage() ; return false;">
                    <font color="F5C518" face="times new roman" size="12">Surprise me</font>
                </a>
                <hr color="F5C518" width="530px" align="left"><br>
            </td>
        </tr>
